        ...
        <>
            <div className='bg-gray-100 flex gap-10 p-5'>
                <button
                    ...
                    className="bg-blue-500 flex items-center gap-5 text-white py-2 px-4 rounded-md hover:text-gray-300 transition duration-300">
                    +  הוסף משתמש
                </button>
            </div>
            <div className="flex items-start justify-center min-h-screen bg-gray-100">
                {showForm && (<>
                    ...
                    <form action="" className='flex flex-col h-full overflow-y-auto g-white p-6 rounded-lg  mt-16 border border-gray-300  shadow-2xl' style={{ width: '700px', height: '600px' }}>
                        <div className="flex justify-end mb-4">
                            <button className="bg-gray-400 text-white font-semibold py-2 px-4 rounded-md hover:bg-gray-500" onClick={() => setShowForm(false)}>
                                X
                            </button>
                        </div>
